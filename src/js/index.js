...
userCardMaker({
  ...
  roomNumber: "224",
  phoneNumber: "(718)-435-45656",readMoreLink: "google.com",
  imagePath:
...
userCardMaker({
  ...
  profession: "NBA Player",
  email: "jack@yahoo.com",
  roomNumber: "224",readMoreLink: "google.com",
  imagePath:
...
userCardMaker({
  name: "Shiggy",
  profession: "Comedian",readMoreLink: "google.com",
  imagePath:
    "https://static.vibe.com/files/2018/08/GettyImages-1001042940-1533829844-compressed.jpg",
});
userCardMaker({
  name: "Donald Trump",readMoreLink: "google.com",
  profession: "US President",
});
userCardMaker({
  name: "Lamelo Ball",readMoreLink: "google.com",
